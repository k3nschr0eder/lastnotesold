...
if [ -n "${GREYSHEET_API_KEY:-}" ]; then ENV_ARGS+=(-e "GREYSHEET_API_KEY=$GREYSHEET_API_KEY"); fi
if [ -n "${GREYSHEET_API_TOKEN:-}" ]; then ENV_ARGS+=(-e "GREYSHEET_API_TOKEN=$GREYSHEET_API_TOKEN"); fi
if [ -n "${SOLDCOMPS_API_TOKEN:-}" ]; then ENV_ARGS+=(-e "SOLDCOMPS_API_TOKEN=$SOLDCOMPS_API_TOKEN"); fi
if [ -n "${EBAY_CLIENT_ID:-}" ]; then ENV_ARGS+=(-e "EBAY_CLIENT_ID=$EBAY_CLIENT_ID"); fi
if [ -n "${EBAY_CLIENT_SECRET:-}" ]; then ENV_ARGS+=(-e "EBAY_CLIENT_SECRET=$EBAY_CLIENT_SECRET"); fi
